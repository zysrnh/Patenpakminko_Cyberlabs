                    ...
                    @foreach($applications as $app)
                        <tr>
                            ...
                            <td style="display:flex; gap:6px; align-items:center; flex-wrap:wrap;">
                                ...
                                @if(Auth::user()->isDpn())
                                <form action="{{ route('psn.destroy', $app->id) }}" method="POST" onsubmit="return confirm('Hapus permanen permohonan {{ $app->application_number }}? Data tidak bisa dikembalikan!')">
                                    @csrf @method('DELETE')
