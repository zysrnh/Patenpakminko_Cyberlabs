                ...
                <div>
                    <div class="card">
                        ...
                        <ul class="detail-list">
                            ...
                            @if($application->approval_document)
                                <li class="detail-item" style="padding: 12px 0;">
                                    <span class="detail-label" style="font-weight: 800; color: #B45309;">Dokumen SK PKKPR Kebijakan (Final)</span>
                                    <span class="detail-val">
...
@if($application->bpn_pertek_document || $application->approval_document)
    @php
        ...
        if ($application->approval_document) {
            ...
            $popupDocDesc = 'Selamat! Dokumen resmi SK PKKPR Kebijakan milik Anda telah diterbitkan secara lengkap.';
