...
<script>
            ...
            <div class="grid-layout">
                ...
                <div>
                    ...
                    <div class="card">
                        ...
                        <div class="doc-list">
                            ...
                            <a href="{{ route('kebijakan.ptp_pdf', $application->id) }}" target="_blank" class="doc-item">
                ...
                <div>
                    <div class="card">
                        <h1 class="page-title">Detail Kebijakan Khusus</h1>
                    </div>
                    ...
                    <div class="card" style="position: sticky; top: 88px;">
                        ...
                        <div class="timeline-card-header">
                            <img
                                src="{{ asset('storage/logo/Kebijakan.png') }}"
                                alt="Logo Kebijakan Khusus"
                            ...
                            <div class="timeline-service-meta">
                                ...
                                <div class="timeline-service-title">Kebijakan Khusus</div>
