...
@section('title', 'Form Permohonanan ' . $serviceName . ' — PATEN PAK MIKO')
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        @if($jenisPermohonan === 'psn')
                            5. Dokumen Penetapan / Rekomendasi PSN dari Kementerian / Lembaga Teknis
                        @elseif($jenisPermohonan === 'tanah-timbul')
                            5. Surat Keterangan Tanah Timbul dari Kepala Desa / Lurah
                        @else
                ...
                <div class="form-group">
                    <label class="form-label">
                        <span class="label-text">
                        @if($jenisPermohonan === 'psn')
                            7. Nomor Induk Berusaha (NIB) / Izin Usaha Sektoral
                        @elseif($jenisPermohonan === 'tanah-timbul')
                ...
                <div class="form-group">
                    <label class="form-label">
                        <span class="label-text">
                        @if($jenisPermohonan === 'psn')
                            8. Dokumen KBLI / Klasifikasi Lapangan Usaha PSN
                        @else
                            8. Dokumen KBLI yang diajukan
                        @endif
                ...
                <div class="form-group">
                    <label class="form-label">
                        <span class="label-text">
                        @if($jenisPermohonan === 'psn')
                            9. Proposal Rencana Kegiatan Berusaha / Proyek Strategis Nasional
                        @else
