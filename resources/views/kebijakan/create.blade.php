...
<head>
    ...
    @endphp
    <title>Form Pengajuan {{ $serviceName }} Ã¢â‚¬â€ PATEN PAK MIKO</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ FORM ELEMENTS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .form-section-title {
            font-size: 14px;
            font-weight: 800;
            text-transform: uppercase;
        ...
        .kbli-dropdown {
            ...
            background: #fff; border: 1.5px solid var(--clr-blue);
            border-radius: var(--radius-md); box-shadow: 0 8px 24px rgba(0,59,100,0.12);
            z-index: 100; max-height: 220px; overflow-y: auto; display: none;
        }
        .kbli-dropdown.show { display: block; }
        .kbli-item {
            padding: 10px 14px; font-size: 13px; color: var(--clr-ink);
            cursor: pointer; border-bottom: 1px solid var(--clr-line);
        ...
        .kbli-desc {
            ...
            background: var(--clr-blue-lt); border: 1px solid var(--clr-line);
            border-radius: var(--radius-sm); font-size: 12.5px;
            color: var(--clr-mid); font-weight: 500;
        }
                ...
                <form action="{{ route('kebijakan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="kbli-wrapper">
                            <input type="text" id="kbli_kode" name="kbli_kode" class="form-control"
                                placeholder="Ketik kode KBLI (cth: 68100) atau nama kegiatan..."
                                value="{{ old('kbli_kode') }}" autocomplete="off" required maxlength="20">
                        ...
                        <p style="font-size: 11px; color: var(--clr-muted); margin-top: 5px;">ðŸ’¡ Ketik minimal 2 karakter untuk saran otomatis. Bisa juga diketik manual.</p>
                    </div>

                    <!-- 8b. Dokumen KBLI -->
                    <div class="form-group">
                        @if($jenisPermohonan === 'psn')
                            <label for="kbli" class="form-label">8b. Dokumen KBLI / Klasifikasi Lapangan Usaha PSN <span class="req">*</span> <button type="button" class="btn-contoh" onclick="openPreview('{{ asset('storage/Contoh_Format/9%20KBLI%20(Klasifikasi%20Baku%20Lapangan%20Usaha%20Indonesia).pdf') }}', 'Contoh Dokumen KBLI')">Lihat Contoh</button></label>
                            <div class="file-input-wrapper">
                                <input type="file" id="kbli" name="kbli" accept=".pdf,.jpg,.jpeg,.png" required>
                                <span class="file-help">Format: PDF, JPG, PNG. Maks. 5MB.</span>
                            </div>
                        @elseif($jenisPermohonan === 'tanah-timbul')
                            <label for="kbli" class="form-label">8b. Berita Acara Peninjauan / Rekomendasi Batas Kelurahan <span class="req">*</span></label>
                            <div class="file-input-wrapper">
                                <input type="file" id="kbli" name="kbli" accept=".pdf,.jpg,.jpeg,.png" required>
                                <span class="file-help">Format: PDF, JPG, PNG. Maks. 5MB.</span>
                            </div>
                        @else
                            <label for="kbli" class="form-label">8b. Dokumen KBLI yang diajukan <span class="req">*</span> <button type="button" class="btn-contoh" onclick="openPreview('{{ asset('storage/Contoh_Format/9%20KBLI%20(Klasifikasi%20Baku%20Lapangan%20Usaha%20Indonesia).pdf') }}', 'Contoh Dokumen KBLI')">Lihat Contoh</button></label>
                            <div class="file-input-wrapper">
                                <input type="file" id="kbli" name="kbli" accept=".pdf,.jpg,.jpeg,.png" required>
                                <span class="file-help">Format: PDF, JPG, PNG. Maks. 5MB.</span>
                            </div>
