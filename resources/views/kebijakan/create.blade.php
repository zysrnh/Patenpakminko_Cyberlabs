    ...
    <div class="ptp-container">
        ...
        <div class="ptp-header-top">
            <div class="ptp-badge">
                ...
                <span class="ptp-badge-name">{{ $serviceName ?? 'Kebijakan Khusus / Lainnya' }}</span>
            </div>
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        @if(!in_array($jenisPermohonan, ['psn', 'tanah-timbul']))
                            <button type="button" class="btn-contoh" onclick="openPreview('{{ asset('storage/Contoh_Format/6%20Akta%20Pendirian.pdf') }}', 'Contoh Akta Pendirian')">Lihat Contoh</button>
                        @endif
                    </label>
                    <div class="file-input-wrapper">
