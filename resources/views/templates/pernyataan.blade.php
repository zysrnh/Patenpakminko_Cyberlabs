...
<body>
    ...
    <div class="document-page">
        ...
        <ol style="margin-left: 20px; padding-left: 0;">
            <li style="margin-bottom: 8px;">Seluruh data, informasi, dokumen, serta berkas persyaratan yang saya unggah dalam pengajuan permohonan Persetujuan Kesesuaian Kegiatan Pemanfaatan Ruang (PKPR) Non-Berusaha pada sistem PATENPAKMIKO adalah <strong>BENAR, ASLI, SAH,</strong> dan sesuai dengan kondisi faktual di lapangan.</li>
