...
@section('title', 'Form Pengajuan PKKPR Berusaha — PATEN PAK MIKO')
        ...
        <form action="{{ route('berusaha.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <!-- Kita tetap pasang required di controller sesuai validasi sebelumnya, tapi label ngikut gambar -->
