                ...
                <div>
                    ...
                    @php
                        ...
                        if ($application->status === 'disetujui' || $application->status === 'ditolak' || $application->bpn_pertek_document) {
                            ...
                            $slaBg = '#D1E7DD';
                            $slaBorder = '#BADBCC';
                            $badgeText = '<svg style="width:14px;height:14px;vertical-align:-2px;margin-right:4px;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg> Selesai Tepat Waktu';
                            $badgeBg = '#198754';
                            $badgeColor = '#FFFFFF';
                        } else {
                            $now = \Carbon\Carbon::now();
