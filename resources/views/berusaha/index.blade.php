...
<head>
    ...
    <title>Layanan PPKPR Berusaha — PATENPAKMIKO</title>
                ...
                <div>
                    <h1 class="page-title">
                        @if(Auth::user()->isPelakuUsaha())
                            Permohonan PPKPR Berusaha Anda
                        @else
                            Daftar Antrean PPKPR Berusaha
                        @endif
                    </h1>
                </div>
                
                @if(Auth::user()->isPelakuUsaha())
                    <a href="{{ route('berusaha.create') }}" class="btn-primary">
            ...
            <div class="card">
                @if($applications->isEmpty())
                    <div class="empty-state">
                        ...
                        <p>
                            @if(Auth::user()->isPelakuUsaha())
                                Anda belum mengajukan permohonan kesesuaian kegiatan pemanfaatan ruang (PPKPR) Berusaha.
                            @else
                                Saat ini tidak ada antrean berkas permohonan PPKPR Berusaha.
                            @endif
                        </p>
                        @if(Auth::user()->isPelakuUsaha())
                            <a href="{{ route('berusaha.create') }}" class="btn-primary">Ajukan Sekarang</a>
                        @endif
                    </div>
                @else
                            ...
                            <tbody>
                                @foreach($applications as $app)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('berusaha.show', $app->id) }}" class="btn-view">
                                                Detail / Lacak
