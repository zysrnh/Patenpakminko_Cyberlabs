    ...
    <div class="ptp-container">
        ...
        <div class="ptp-header-top">
            <div class="ptp-badge">
                ...
                <span class="ptp-badge-name">Pertimbangan Teknis Pertanahan PKKPR Non Berusaha</span>
            </div>
            <a href="{{ route('non-berusaha.index') }}" class="btn-kembali">&larr; Kembali</a>
        </div>
        @if(session('success'))
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        <button type="button" class="btn-contoh" onclick="openPreview('{{ \App\Models\TemplateDokumen::getPreviewUrl('contoh_2_sketsa_lokasi', 'storage/Contoh_Format/2. SKETSA LOKASI.pdf') }}', 'Contoh Peta / Sketsa Lokasi')">Lihat Contoh</button>
                    </label>
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        <button type="button" class="btn-contoh" onclick="openPreview('{{ \App\Models\TemplateDokumen::getPreviewUrl('contoh_4_ktp', 'storage/Contoh_Format/4. Contoh KTP.pdf') }}', 'Contoh Fotokopi KTP')">Lihat Contoh</button>
                    </label>
                    <div class="file-input-wrapper">
                ...
                <div class="form-group">
                    <label class="form-label">
                        <span class="label-text">5. Fotokopi Akta Pendirian & Pengesahan Badan Hukum<span class="optional">(Opsional jika Perorangan)</span></span>
                ...
                <div class="form-group">
                    <label class="form-label">
                        <span class="label-text">9. Proposal Rencana Kegiatan Non-Berusaha<span class="optional">(Opsional)</span></span>
