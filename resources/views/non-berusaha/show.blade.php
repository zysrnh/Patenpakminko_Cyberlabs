                ...
                <div>
                    <div class="card">
                        ...
                        <ul class="detail-list">
                            ...
                            @if($application->bpn_sps_document)
                                <li class="detail-item">
                                    <span class="detail-label">Dokumen Surat Perintah Setor (SPS)</span>
                                    <span class="detail-val">
                                        <a href="{{ route('file.view', ['path' => $application->bpn_sps_document]) }}" target="_blank" class="btn-doc">
                                            Unduh Dokumen SPS
                                        </a>
                                    </span>
                                </li>
                            ...
                            @if($application->approval_document)
                                <li class="detail-item">
                                    <span class="detail-label">Dokumen PKKPR Non Berusaha Terbit</span>
                                    <span class="detail-val">
