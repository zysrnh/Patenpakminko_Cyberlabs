...
@section('title', 'Form Permohonan Pertimbangan Teknis Pertanahan TANAH TIMBUL — PATEN PAK MIKO')
    ...
    <div class="ptp-container">
        ...
        <form action="{{ route('tanah-timbul.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                @if($ptpHubungan !== 'Diri Sendiri')
                <div class="form-group">
                    <label class="form-label">Hubungan Pemohon<span class="required">*</span></label>
