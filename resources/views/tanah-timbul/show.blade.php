                        ...
                        <ul class="detail-list">
                            ...
                            <li class="detail-item">
                                ...
                                <span class="detail-val" style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    @if(Auth::user()->isBpn())
                                        <form action="{{ route('application.rollback', ['tanah-timbul', $application->id]) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan dan mengembalikan permohonan ini ke lini masa/tahap sebelumnya?')">
                                            @csrf
